...
#Login Bots
client = LINE('EwKvv9UFGCNVK2tRSP98.GnFFp7StNEt6vhGIuMMOQa.v2MKvn0vyIhDwwYFzOKHb3cQMzph48AxdtgvD7Yh8rU=')
...
def RECEIVE_MESSAGE(op):
            ...
            if msg.contentType == 0:
             ...
             if sender in Admin + Owner:
               if clienttxt.lower() == "pro8help":help(sky,'')
               if clienttxt.lower() == "blacklist":defblacklist(sky,'')
               if clienttxt.lower() == "pro8 speed":speed(sky,'')
               ...
               if clienttxt.lower() == "proinv off":
                    ...
                    protectinvoff(sky)
               if clienttxt.lower() == "pro8 changedp":changedp(sky)
               if clienttxt.lower() == "pro8 changegp":changegp(sky)
               ...
               if clienttxt.lower() == "pro8 list sticker":liststicker(sky)
               ...
               if clienttxt.lower() == 'pro8 blist':blist(sky,'')
             ...
             if clienttxt.lower() == 'pro8 adminlist':
                  if sender in Admin + Owner:
                   if Admin == []:
             ...
             if clienttxt.lower() == 'pro8 stafflist':
                  if sender in Admin + Owner:
                   if Staff == []:
             ...
             elif msg.text.startswith("pro8join "):
                  if sender in Admin + Owner:
                            text = msg.text.split()
                            number = text[1]
                            if number.isdigit():
             ...
             if clienttxt.lower() == 'pro8 getban':
                  if sender in Admin + Owner:
                            if ban["blacklist"] == {}:
             ...
             if clienttxt.lower() == 'pro8 lurk on':
               if sender in Admin + Owner:
             ...
             if clienttxt.lower() == 'pro8 lurk off':
               if sender in Admin + Owner:
             ...
             if clienttxt.lower() == 'pro8 lurk result':
               if sender in Admin + Owner:
                try:
...
#==============================[ Message Command ]==============================#
             if clienttxt.lower() == "pro8 openqr":
              if sender in Admin + Owner:
               if msg.toType == 2:
...
#==============================[ Message Command ]==============================#
             if clienttxt.lower() == "pro8 closeqr":
              if sender in Admin + Owner:
               if msg.toType == 2:
                x = client.getGroup(sky)
...
#==============================[ Message Command ]==============================#
             ...
             if clienttxt.startswith('pro8 delstick'):
               if sender in Admin + Owner:
...
#==============================[ Message Command ]==============================#
             if clienttxt.startswith('pro8 addstick'):
               if sender in Admin + Owner:
                separate = clienttxt.split("er ")
                text = clienttxt.replace(separate[0]+"er ","")
...
def help(to, text):
    ...
    +"pro8 Openqr\n╠ " \
    +"pro8 Closeqr\n╠ " \
    +"pro8 Addsticker 「 Title 」\n╠ " \
    +"pro8 Delsticker 「 Title 」\n╠ " \
    +"pro Bye 「 @ 」\n╠ " \
    +"Abl 「 @ 」\n╠ " \
    +"Ubl 「 @ 」\n╚═════" \
