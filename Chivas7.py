...
#Login Bots
client = LINE('EwRPxO6oGnwSn5Pmoe2a.JyfcBGZ50T+jPtaqy5+rUG.OlOsy9RDJCIlgwEk0KkDnKSAqsM3iwQjx5ZpryH223M=')
...
def RECEIVE_MESSAGE(op):
            ...
            if msg.contentType == 0:
             ...
             if sender in Admin + Owner:
               if clienttxt.lower() == "pro7help":help(sky,'')
               if clienttxt.lower() == "blacklist":defblacklist(sky,'')
               if clienttxt.lower() == "pro7 speed":speed(sky,'')
               ...
               if clienttxt.lower() == "proinv off":
                    ...
                    protectinvoff(sky)
               if clienttxt.lower() == "pro7 changedp":changedp(sky)
               if clienttxt.lower() == "pro7 changegp":changegp(sky)
               ...
               if clienttxt.lower() == "pro7 list sticker":liststicker(sky)
               ...
               if clienttxt.lower() == 'pro7 blist':blist(sky,'')
             ...
             if clienttxt.lower() == 'pro7 adminlist':
                  if sender in Admin + Owner:
                   if Admin == []:
             ...
             if clienttxt.lower() == 'pro7 stafflist':
                  if sender in Admin + Owner:
                   if Staff == []:
             ...
             elif msg.text.startswith("pro7join "):
                  if sender in Admin + Owner:
                            text = msg.text.split()
                            number = text[1]
                            if number.isdigit():
             ...
             if clienttxt.lower() == 'pro7 getban':
                  if sender in Admin + Owner:
                            if ban["blacklist"] == {}:
             ...
             if clienttxt.lower() == 'pro7 lurk on':
               if sender in Admin + Owner:
             ...
             if clienttxt.lower() == 'pro7 lurk off':
               if sender in Admin + Owner:
             ...
             if clienttxt.lower() == 'pro7 lurk result':
               if sender in Admin + Owner:
                try:
...
#==============================[ Message Command ]==============================#
             if clienttxt.lower() == "pro7 openqr":
              if sender in Admin + Owner:
               if msg.toType == 2:
...
#==============================[ Message Command ]==============================#
             if clienttxt.lower() == "pro7 closeqr":
              if sender in Admin + Owner:
               if msg.toType == 2:
                x = client.getGroup(sky)
...
#==============================[ Message Command ]==============================#
             ...
             if clienttxt.startswith('pro7 delstick'):
               if sender in Admin + Owner:
...
#==============================[ Message Command ]==============================#
             if clienttxt.startswith('pro7 addstick'):
               if sender in Admin + Owner:
                separate = clienttxt.split("er ")
                text = clienttxt.replace(separate[0]+"er ","")
...
def help(to, text):
    ...
    +"pro7 Openqr\n╠ " \
    +"pro7 Closeqr\n╠ " \
    +"pro7 Addsticker 「 Title 」\n╠ " \
    +"pro7 Delsticker 「 Title 」\n╠ " \
    +"pro Bye 「 @ 」\n╠ " \
    +"Abl 「 @ 」\n╠ " \
    +"Ubl 「 @ 」\n╚═════" \
