...
#Login Bots
client = LINE('EwVVkZCRQGHR1U9ajTff.FzaUu48a0nSc1osIFoyIdW.XLBztjAACXh3FLLduy0jGebs2Cw2C/BvyWI2y+1/qQU=')
...
def RECEIVE_MESSAGE(op):
            ...
            if msg.contentType == 0:
             ...
             if sender in Admin + Owner:
               if clienttxt.lower() == "pro9help":help(sky,'')
               if clienttxt.lower() == "blacklist":defblacklist(sky,'')
               if clienttxt.lower() == "pro9 speed":speed(sky,'')
               ...
               if clienttxt.lower() == "proinv off":
                    ...
                    protectinvoff(sky)
               if clienttxt.lower() == "pro9 changedp":changedp(sky)
               if clienttxt.lower() == "pro9 changegp":changegp(sky)
               ...
               if clienttxt.lower() == "pro9 list sticker":liststicker(sky)
               ...
               if clienttxt.lower() == 'pro9 blist':blist(sky,'')
             ...
             if clienttxt.lower() == 'pro9 adminlist':
                  if sender in Admin + Owner:
                   if Admin == []:
             ...
             if clienttxt.lower() == 'pro9 stafflist':
                  if sender in Admin + Owner:
                   if Staff == []:
             ...
             elif msg.text.startswith("pro9join "):
                  if sender in Admin + Owner:
                            text = msg.text.split()
                            number = text[1]
                            if number.isdigit():
             ...
             if clienttxt.lower() == 'pro9 getban':
                  if sender in Admin + Owner:
                            if ban["blacklist"] == {}:
             ...
             if clienttxt.lower() == 'pro9 lurk on':
               if sender in Admin + Owner:
             ...
             if clienttxt.lower() == 'pro9 lurk off':
               if sender in Admin + Owner:
             ...
             if clienttxt.lower() == 'pro9 lurk result':
               if sender in Admin + Owner:
                try:
...
#==============================[ Message Command ]==============================#
             if clienttxt.lower() == "pro9 openqr":
              if sender in Admin + Owner:
               if msg.toType == 2:
...
#==============================[ Message Command ]==============================#
             if clienttxt.lower() == "pro9 closeqr":
              if sender in Admin + Owner:
               if msg.toType == 2:
                x = client.getGroup(sky)
...
#==============================[ Message Command ]==============================#
             ...
             if clienttxt.startswith('pro9 delstick'):
               if sender in Admin + Owner:
...
#==============================[ Message Command ]==============================#
             if clienttxt.startswith('pro9 addstick'):
               if sender in Admin + Owner:
                separate = clienttxt.split("er ")
                text = clienttxt.replace(separate[0]+"er ","")
...
def help(to, text):
    ...
    +"pro9 Openqr\n╠ " \
    +"pro9 Closeqr\n╠ " \
    +"pro9 Addsticker 「 Title 」\n╠ " \
    +"pro9 Delsticker 「 Title 」\n╠ " \
    +"pro Bye 「 @ 」\n╠ " \
    +"Abl 「 @ 」\n╠ " \
    +"Ubl 「 @ 」\n╚═════" \
