...
#Login Bots
client = LINE('Ew3cyeT6FvCymEayXrD2.CMf0W7jFKMCfoRGfc3RkqG.jJQLxfuT/Eq0Uavt1aXmBs3I7yh/Nvg9LxAQ+8VbtSQ=')
...
def RECEIVE_MESSAGE(op):
            ...
            if msg.contentType == 0:
             ...
             if sender in Admin + Owner:
               if clienttxt.lower() == "pro1help":help(sky,'')
               if clienttxt.lower() == "blacklist":defblacklist(sky,'')
               if clienttxt.lower() == "pro1 speed":speed(sky,'')
               ...
               if clienttxt.lower() == "proinv off":
                    ...
                    protectinvoff(sky)
               if clienttxt.lower() == "pro1 changedp":changedp(sky)
               if clienttxt.lower() == "pro1 changegp":changegp(sky)
               ...
               if clienttxt.lower() == "pro1 list sticker":liststicker(sky)
               ...
               if clienttxt.lower() == 'pro1 blist':blist(sky,'')
             ...
             if clienttxt.lower() == 'pro1 adminlist':
                  if sender in Admin + Owner:
                   if Admin == []:
             ...
             if clienttxt.lower() == 'pro1 stafflist':
                  if sender in Admin + Owner:
                   if Staff == []:
             ...
             elif msg.text.startswith("pro1join "):
                  if sender in Admin + Owner:
                            text = msg.text.split()
                            number = text[1]
                            if number.isdigit():
             ...
             if clienttxt.lower() == 'pro1 getban':
                  if sender in Admin + Owner:
                            if ban["blacklist"] == {}:
             ...
             if clienttxt.lower() == 'pro1 lurk on':
               if sender in Admin + Owner:
             ...
             if clienttxt.lower() == 'pro1 lurk off':
               if sender in Admin + Owner:
             ...
             if clienttxt.lower() == 'pro1 lurk result':
               if sender in Admin + Owner:
                try:
...
#==============================[ Message Command ]==============================#
             if clienttxt.lower() == "pro1 closeqr":
              if sender in Admin + Owner:
               if msg.toType == 2:
                x = client.getGroup(sky)
...
def help(to, text):
    ...
    +"pro1 Openqr\n╠ " \
    +"pro1 Closeqr\n╠ " \
    +"pro1 Addsticker 「 Title 」\n╠ " \
    +"pro1 Delsticker 「 Title 」\n╠ " \
    +"pro Bye 「 @ 」\n╠ " \
    +"Abl 「 @ 」\n╠ " \
    +"Ubl 「 @ 」\n╚═════" \
