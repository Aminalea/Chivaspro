...
#Login Bots
client = LINE('EwyzygXIXs0NpldBL2b6.pPdBefEmdAotJZ+QgHCXzG.6QjhexLipE0oAZReBIWh2RWoKyeOx40rb+CQsoPx07Y=')
...
def RECEIVE_MESSAGE(op):
            ...
            if msg.contentType == 0:
             ...
             if sender in Admin + Owner:
               if clienttxt.lower() == "pro3help":help(sky,'')
               if clienttxt.lower() == "blacklist":defblacklist(sky,'')
               if clienttxt.lower() == "pro3 speed":speed(sky,'')
               ...
               if clienttxt.lower() == "proinv off":
                    ...
                    protectinvoff(sky)
               if clienttxt.lower() == "pro3 changedp":changedp(sky)
               if clienttxt.lower() == "pro3 changegp":changegp(sky)
               ...
               if clienttxt.lower() == "pro3 list sticker":liststicker(sky)
               ...
               if clienttxt.lower() == 'pro3 blist':blist(sky,'')
             ...
             if clienttxt.lower() == 'pro3 adminlist':
                  if sender in Admin + Owner:
                   if Admin == []:
             ...
             if clienttxt.lower() == 'pro3 stafflist':
                  if sender in Admin + Owner:
                   if Staff == []:
             ...
             elif msg.text.startswith("pro3join "):
                  if sender in Admin + Owner:
                            text = msg.text.split()
                            number = text[1]
                            if number.isdigit():
             ...
             if clienttxt.lower() == 'pro3 getban':
                  if sender in Admin + Owner:
                            if ban["blacklist"] == {}:
             ...
             if clienttxt.lower() == 'pro3 lurk on':
               if sender in Admin + Owner:
             ...
             if clienttxt.lower() == 'pro3 lurk off':
               if sender in Admin + Owner:
             ...
             if clienttxt.lower() == 'pro3 lurk result':
               if sender in Admin + Owner:
                try:
...
#==============================[ Message Command ]==============================#
             if clienttxt.lower() == "pro1 openqr":
              if sender in Admin + Owner:
               if msg.toType == 2:
...
#==============================[ Message Command ]==============================#
             if clienttxt.lower() == "pro3 closeqr":
              if sender in Admin + Owner:
               if msg.toType == 2:
                x = client.getGroup(sky)
...
#==============================[ Message Command ]==============================#
             ...
             if clienttxt.startswith('pro3 delstick'):
               if sender in Admin + Owner:
...
#==============================[ Message Command ]==============================#
             if clienttxt.startswith('pro3 addstick'):
               if sender in Admin + Owner:
                separate = clienttxt.split("er ")
                text = clienttxt.replace(separate[0]+"er ","")
...
def help(to, text):
    ...
    +"pro3 Openqr\n╠ " \
    +"pro3 Closeqr\n╠ " \
    +"pro3 Addsticker 「 Title 」\n╠ " \
    +"pro3 Delsticker 「 Title 」\n╠ " \
    +"pro Bye 「 @ 」\n╠ " \
    +"Abl 「 @ 」\n╠ " \
    +"Ubl 「 @ 」\n╚═════" \
