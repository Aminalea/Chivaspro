...
#Login Bots
client = LINE('EwUMxqiZWqbuAMrlkln9.WO57XEm4HtRR1JbxWF91Eq.tSVCuPZGxHO8uJO/8kfjpRvFUeCpBxcuRIWeQPQSLns=')
...
def RECEIVE_MESSAGE(op):
            ...
            if msg.contentType == 0:
             ...
             if sender in Admin + Owner:
               if clienttxt.lower() == "pro4help":help(sky,'')
               if clienttxt.lower() == "blacklist":defblacklist(sky,'')
               if clienttxt.lower() == "pro4 speed":speed(sky,'')
               ...
               if clienttxt.lower() == "proinv off":
                    ...
                    protectinvoff(sky)
               if clienttxt.lower() == "pro4 changedp":changedp(sky)
               if clienttxt.lower() == "pro4 changegp":changegp(sky)
               ...
               if clienttxt.lower() == "pro4 list sticker":liststicker(sky)
               ...
               if clienttxt.lower() == 'pro4 blist':blist(sky,'')
             ...
             if clienttxt.lower() == 'pro4 adminlist':
                  if sender in Admin + Owner:
                   if Admin == []:
             ...
             if clienttxt.lower() == 'pro4 stafflist':
                  if sender in Admin + Owner:
                   if Staff == []:
             ...
             elif msg.text.startswith("pro4join "):
                  if sender in Admin + Owner:
                            text = msg.text.split()
                            number = text[1]
                            if number.isdigit():
             ...
             if clienttxt.lower() == 'pro4 getban':
                  if sender in Admin + Owner:
                            if ban["blacklist"] == {}:
             ...
             if clienttxt.lower() == 'pro4 lurk on':
               if sender in Admin + Owner:
             ...
             if clienttxt.lower() == 'pro4 lurk off':
               if sender in Admin + Owner:
             ...
             if clienttxt.lower() == 'pro4 lurk result':
               if sender in Admin + Owner:
                try:
...
#==============================[ Message Command ]==============================#
             if clienttxt.lower() == "pro4 openqr":
              if sender in Admin + Owner:
               if msg.toType == 2:
...
#==============================[ Message Command ]==============================#
             if clienttxt.lower() == "pro4 closeqr":
              if sender in Admin + Owner:
               if msg.toType == 2:
                x = client.getGroup(sky)
...
#==============================[ Message Command ]==============================#
             ...
             if clienttxt.startswith('pro4 delstick'):
               if sender in Admin + Owner:
...
def help(to, text):
    ...
    +"pro4 Openqr\n╠ " \
    +"pro4 Closeqr\n╠ " \
    +"pro4 Addsticker 「 Title 」\n╠ " \
    +"pro4 Delsticker 「 Title 」\n╠ " \
    +"pro Bye 「 @ 」\n╠ " \
    +"Abl 「 @ 」\n╠ " \
    +"Ubl 「 @ 」\n╚═════" \
