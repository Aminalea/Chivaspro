...
#Login Bots
client = LINE('EwTO1m115kJYIOq4vAHf.Bczx0N7TlRRgQwghuGeuhW.GuKFUU34ISWzpva38pzBkdGvLyMBY17JboboFvRegsI=')
...
def RECEIVE_MESSAGE(op):
            ...
            if msg.contentType == 0:
             ...
             if sender in Admin + Owner:
               if clienttxt.lower() == "pro6help":help(sky,'')
               if clienttxt.lower() == "blacklist":defblacklist(sky,'')
               if clienttxt.lower() == "pro6 speed":speed(sky,'')
               ...
               if clienttxt.lower() == "proinv off":
                    ...
                    protectinvoff(sky)
               if clienttxt.lower() == "pro6 changedp":changedp(sky)
               if clienttxt.lower() == "pro6 changegp":changegp(sky)
               ...
               if clienttxt.lower() == "pro6 list sticker":liststicker(sky)
               ...
               if clienttxt.lower() == 'pro6 blist':blist(sky,'')
             ...
             if clienttxt.lower() == 'pro6 adminlist':
                  if sender in Admin + Owner:
                   if Admin == []:
             ...
             if clienttxt.lower() == 'pro6 stafflist':
                  if sender in Admin + Owner:
                   if Staff == []:
             ...
             elif msg.text.startswith("pro6join "):
                  if sender in Admin + Owner:
                            text = msg.text.split()
                            number = text[1]
                            if number.isdigit():
             ...
             if clienttxt.lower() == 'pro6 getban':
                  if sender in Admin + Owner:
                            if ban["blacklist"] == {}:
             ...
             if clienttxt.lower() == 'pro6 lurk on':
               if sender in Admin + Owner:
             ...
             if clienttxt.lower() == 'pro6 lurk off':
               if sender in Admin + Owner:
             ...
             if clienttxt.lower() == 'pro6 lurk result':
               if sender in Admin + Owner:
                try:
...
#==============================[ Message Command ]==============================#
             if clienttxt.lower() == "pro6 openqr":
              if sender in Admin + Owner:
               if msg.toType == 2:
...
#==============================[ Message Command ]==============================#
             if clienttxt.lower() == "pro6 closeqr":
              if sender in Admin + Owner:
               if msg.toType == 2:
                x = client.getGroup(sky)
...
#==============================[ Message Command ]==============================#
             ...
             if clienttxt.startswith('pro6 delstick'):
               if sender in Admin + Owner:
...
#==============================[ Message Command ]==============================#
             if clienttxt.startswith('pro6 addstick'):
               if sender in Admin + Owner:
                separate = clienttxt.split("er ")
                text = clienttxt.replace(separate[0]+"er ","")
...
def help(to, text):
    ...
    +"pro6 Openqr\n╠ " \
    +"pro6 Closeqr\n╠ " \
    +"pro6 Addsticker 「 Title 」\n╠ " \
    +"pro6 Delsticker 「 Title 」\n╠ " \
    +"pro Bye 「 @ 」\n╠ " \
    +"Abl 「 @ 」\n╠ " \
    +"Ubl 「 @ 」\n╚═════" \
