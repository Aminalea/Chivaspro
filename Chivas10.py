...
#Login Bots
client = LINE('EwjoMwrd6DXmZw05OpTb.SyMcQmS4Z4Six/HICLCgkW.I9irSAk0JiPgii0rZJq+5FePABu+LnULpXMrP8b/aMo=')
...
def RECEIVE_MESSAGE(op):
            ...
            if msg.contentType == 0:
             ...
             if sender in Admin + Owner:
               if clienttxt.lower() == "pro10help":help(sky,'')
               if clienttxt.lower() == "blacklist":defblacklist(sky,'')
               if clienttxt.lower() == "pro10 speed":speed(sky,'')
               ...
               if clienttxt.lower() == "proinv off":
                    ...
                    protectinvoff(sky)
               if clienttxt.lower() == "pro10 changedp":changedp(sky)
               if clienttxt.lower() == "pro10 changegp":changegp(sky)
               ...
               if clienttxt.lower() == "pro10 list sticker":liststicker(sky)
               ...
               if clienttxt.lower() == 'pro10 blist':blist(sky,'')
             ...
             if clienttxt.lower() == 'pro10 adminlist':
                  if sender in Admin + Owner:
                   if Admin == []:
             ...
             if clienttxt.lower() == 'pro10 stafflist':
                  if sender in Admin + Owner:
                   if Staff == []:
             ...
             if clienttxt.lower() == 'pro10 plist':
                  if sender in Admin + Owner:
                            if wait["pro_name"] == {}:
             ...
             elif msg.text.startswith("pro10join "):
                  if sender in Admin + Owner:
                            text = msg.text.split()
                            number = text[1]
                            if number.isdigit():
             ...
             if clienttxt.lower() == 'pro10 glist':
                                    groups = client.groups
                                    ret_ = "╔══[ Group List ]"
                                    no = 0 
                                    for gid in groups:
             ...
             if clienttxt.lower() == 'pro10 getban':
                  if sender in Admin + Owner:
                            if ban["blacklist"] == {}:
             ...
             if clienttxt.lower() == 'pro10 lurk on':
               if sender in Admin + Owner:
             ...
             if clienttxt.lower() == 'pro10 lurk off':
               if sender in Admin + Owner:
             ...
             if clienttxt.lower() == 'pro10 lurk result':
               if sender in Admin + Owner:
                try:
...
#==============================[ Message Command ]==============================#
             if clienttxt.lower() == "pro10 openqr":
              if sender in Admin + Owner:
               if msg.toType == 2:
...
#==============================[ Message Command ]==============================#
             if clienttxt.lower() == "pro10 closeqr":
              if sender in Admin + Owner:
               if msg.toType == 2:
                x = client.getGroup(sky)
...
#==============================[ Message Command ]==============================#
             ...
             if clienttxt.startswith('pro10 delstick'):
               if sender in Admin + Owner:
...
#==============================[ Message Command ]==============================#
             if clienttxt.startswith('pro10 addstick'):
               if sender in Admin + Owner:
                separate = clienttxt.split("er ")
                text = clienttxt.replace(separate[0]+"er ","")
...
def help(to, text):
    ...
    +"pro10 Openqr\n╠ " \
    +"pro10 Closeqr\n╠ " \
    +"pro10 Addsticker 「 Title 」\n╠ " \
    +"pro10 Delsticker 「 Title 」\n╠ " \
    +"pro Bye 「 @ 」\n╠ " \
    +"Abl 「 @ 」\n╠ " \
    +"Ubl 「 @ 」\n╚═════" \
