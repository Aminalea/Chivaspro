...
#Login Bots
client = LINE('Ewfe86ma6xNb4i2UunVc.WCHVM61U3NB24I4BwqiFNa.VmvnvQ0jly1t/E56qMQQv15pH+c7xHIp3rwxBmYVES0=')
...
def RECEIVE_MESSAGE(op):
            ...
            if msg.contentType == 0:
             ...
             if sender in Admin + Owner:
               if clienttxt.lower() == "pro5help":help(sky,'')
               if clienttxt.lower() == "blacklist":defblacklist(sky,'')
               if clienttxt.lower() == "pro5 speed":speed(sky,'')
               ...
               if clienttxt.lower() == "proinv off":
                    ...
                    protectinvoff(sky)
               if clienttxt.lower() == "pro5 changedp":changedp(sky)
               if clienttxt.lower() == "pro5 changegp":changegp(sky)
               ...
               if clienttxt.lower() == "pro5 list sticker":liststicker(sky)
               ...
               if clienttxt.lower() == 'pro5 blist':blist(sky,'')
             ...
             if clienttxt.lower() == 'pro5 adminlist':
                  if sender in Admin + Owner:
                   if Admin == []:
             ...
             if clienttxt.lower() == 'pro5 stafflist':
                  if sender in Admin + Owner:
                   if Staff == []:
             ...
             elif msg.text.startswith("pro5join "):
                  if sender in Admin + Owner:
                            text = msg.text.split()
                            number = text[1]
                            if number.isdigit():
             ...
             if clienttxt.lower() == 'pro5 getban':
                  if sender in Admin + Owner:
                            if ban["blacklist"] == {}:
             ...
             if clienttxt.lower() == 'pro5 lurk on':
               if sender in Admin + Owner:
             ...
             if clienttxt.lower() == 'pro5 lurk off':
               if sender in Admin + Owner:
             ...
             if clienttxt.lower() == 'pro5 lurk result':
               if sender in Admin + Owner:
                try:
...
#==============================[ Message Command ]==============================#
             if clienttxt.lower() == "pro5 openqr":
              if sender in Admin + Owner:
               if msg.toType == 2:
...
#==============================[ Message Command ]==============================#
             if clienttxt.lower() == "pro5 closeqr":
              if sender in Admin + Owner:
               if msg.toType == 2:
                x = client.getGroup(sky)
...
#==============================[ Message Command ]==============================#
             ...
             if clienttxt.startswith('pro5 delstick'):
               if sender in Admin + Owner:
...
#==============================[ Message Command ]==============================#
             if clienttxt.startswith('pro5 addstick'):
               if sender in Admin + Owner:
                separate = clienttxt.split("er ")
                text = clienttxt.replace(separate[0]+"er ","")
...
def help(to, text):
    ...
    +"pro5 Openqr\n╠ " \
    +"pro5 Closeqr\n╠ " \
    +"pro5 Addsticker 「 Title 」\n╠ " \
    +"pro5 Delsticker 「 Title 」\n╠ " \
    +"pro Bye 「 @ 」\n╠ " \
    +"Abl 「 @ 」\n╠ " \
    +"Ubl 「 @ 」\n╚═════" \
